...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.SuperAdmin = field.NewBool(tableName, "super_admin")
	_user.Status = field.NewString(tableName, "status")
	_user.AvatarAssetID = field.NewInt64(tableName, "avatar_asset_id")
	_user.Avatar = userBelongsToAvatar{
		db: db.Session(&gorm.Session{}),

		RelationField: field.NewRelation("Avatar", "models.Asset"),
		Author: struct {
			field.RelationField
			Avatar struct {
				field.RelationField
			...
			RelationField: field.NewRelation("Avatar.Author", "models.User"),
			Avatar: struct {
				field.RelationField
			}{
				RelationField: field.NewRelation("Avatar.Author.Avatar", "models.Asset"),
			},
		},
		TagEntries: struct {
			field.RelationField
			...
			RelationField: field.NewRelation("Avatar.TagEntries", "models.TagEntry"),
			Tag: struct {
				field.RelationField
				Parent struct {
					field.RelationField
				...
				RelationField: field.NewRelation("Avatar.TagEntries.Tag", "models.Tag"),
				Parent: struct {
					field.RelationField
				}{
					RelationField: field.NewRelation("Avatar.TagEntries.Tag.Parent", "models.Tag"),
				},
				Children: struct {
					field.RelationField
				}{
					RelationField: field.NewRelation("Avatar.TagEntries.Tag.Children", "models.Tag"),
				},
			},
		},
	}
...
func (u *user) updateTableName(table string) *user {
	...
	u.SuperAdmin = field.NewBool(table, "super_admin")
	u.Status = field.NewString(table, "status")
	u.AvatarAssetID = field.NewInt64(table, "avatar_asset_id")
...
func (u *user) fillFieldMap() {
	...
	u.fieldMap["super_admin"] = u.SuperAdmin
	u.fieldMap["status"] = u.Status
	u.fieldMap["avatar_asset_id"] = u.AvatarAssetID
...
func (a userBelongsToAvatar) Model(m *models.User) *userBelongsToAvatarTx {
	return &userBelongsToAvatarTx{a.db.Model(m).Association(a.Name())}
}

type userBelongsToAvatarTx struct{ tx *gorm.Association }

func (a userBelongsToAvatarTx) Find() (result *models.Asset, err error) {
	return result, a.tx.Find(&result)
}

func (a userBelongsToAvatarTx) Append(values ...*models.Asset) (err error) {
...
func (a userBelongsToAvatarTx) Replace(values ...*models.Asset) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a userBelongsToAvatarTx) Delete(values ...*models.Asset) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
